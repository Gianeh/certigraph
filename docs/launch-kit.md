...
This page mirrors the root `LAUNCH_KIT.md`. Use it when publishing the repository.

## Positioning

CertiGraph is not “a graph library.” It is a verification layer for graph results from tools you do not want to trust blindly.
